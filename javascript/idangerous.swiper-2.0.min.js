...
var Swiper = function(a, b) {
    ...
    function x() {
        function f(a) {
            ...
            c.onload = function() {
                e.imagesLoaded++,
                e.imagesLoaded == e.imagesToLoad.length && (e.reInit(), b.onImagesReady && b.onImagesReady(e))
            },
            c.src = a
        }
    ...
    function A(a) {
        ...
        if (37 == b || 39 == b || 38 == b || 40 == b) {
            for (var c = !1,
            d = e.h.getOffset(e.container), f = e.h.windowScroll().left, g = e.h.windowScroll().top, h = e.h.windowWidth(), i = e.h.windowHeight(), j = [[d.left, d.top], [d.left + e.width, d.top], [d.left, d.top + e.height], [d.left + e.width, d.top + e.height]], k = 0; j.length > k; k++) {
                var l = j[k];
    ...
    function B(a) {
        ...
        if (a.detail ? d = -a.detail: "mousewheel" == c ? d = a.wheelDelta: "DOMMouseScroll" == c ? d = -a.detail: "wheel" == c && (d = Math.abs(a.deltaX) > Math.abs(a.deltaY) ? -a.deltaX: -a.deltaY), b.freeMode) {
            ...
            var g, h;
            o ? (g = e.getWrapperTranslate("x") + d, h = e.getWrapperTranslate("y"), g > 0 && (g = 0), -v() > g && (g = -v())) : (g = e.getWrapperTranslate("x"), h = e.getWrapperTranslate("y") + d, h > 0 && (h = 0), -v() > h && (h = -v())),
            e.setWrapperTransition(0),
            e.setWrapperTranslate(g, h, 0)
        } else 0 > d ? e.swipeNext() : e.swipePrev();
        return b.autoplay && e.stopAutoplay(),
    ...
    function D() {
        e.clickedSlide = this,
        e.clickedSlideIndex = e.slides.indexOf(this),
        b.onSlideTouch(e)
    }
    function E(a) {
    ...
    function M(a) {
        if (e.isTouched && !b.onlyExternal && (!G || "mousemove" != a.type)) {
            var c = G ? a.targetTouches[0].pageX: a.pageX || a.clientX,
            d = G ? a.targetTouches[0].pageY: a.pageY || a.clientY;
            if (j === void 0 && o && (j = !!(j || Math.abs(d - e.touches.startY) > Math.abs(c - e.touches.startX))), void 0 !== j || o || (j = !!(j || Math.abs(d - e.touches.startY) < Math.abs(c - e.touches.startX))), j) return e.isTouched = !1,
            void 0;
            ...
            if (a.assignedToSwiper = !0, e.isMoved = !0, b.preventLinks && (e.allowLinks = !1), b.onSlideClick && (e.allowSlideClick = !1), b.autoplay && e.stopAutoplay(), !G || 1 == a.touches.length) {
                ...
                return b.moveStartThreshold ? Math.abs(e.touches.current - e.touches.start) > b.moveStartThreshold || H ? (H = !0, o ? e.setWrapperTranslate(e.positions.current, 0, 0) : e.setWrapperTranslate(0, e.positions.current, 0)) : e.positions.current = e.positions.start: o ? e.setWrapperTranslate(e.positions.current, 0, 0) : e.setWrapperTranslate(0, e.positions.current, 0),
    ...
    function N() {
        if (j && e.swipeReset(), !b.onlyExternal && e.isTouched) {
            ...
            100), !e.isMoved) return e.isMoved = !1,
            b.onTouchEnd && b.onTouchEnd(e),
            e.callPlugins("onTouchEnd"),
            void 0;
            e.isMoved = !1;
            var h = v();
            if (e.positions.current > 0) return e.swipeReset(),
            b.onTouchEnd && b.onTouchEnd(e),
            e.callPlugins("onTouchEnd"),
            void 0;
            if ( - h > e.positions.current) return e.swipeReset(),
            b.onTouchEnd && b.onTouchEnd(e),
            e.callPlugins("onTouchEnd"),
            void 0;
            if (b.freeMode) {
                if (b.freeModeFluid) {
                    ...
                    p = !1,
                    r = 20 * Math.abs(e.velocity) * b.momentumBounceRatio; - h > n && (b.momentumBounce && e.support.transitions ? ( - r > n + h && (n = -h - r), q = -h, p = !0, I = !0) : n = -h),
                    ...
                    b.momentumBounce && p && e.wrapperTransitionEnd(function() {
                ...
                return (!b.freeModeFluid || f >= 300) && e.updateActiveSlide(e.positions.current),
                b.onTouchEnd && b.onTouchEnd(e),
                e.callPlugins("onTouchEnd"),
                void 0
            }
    ...
    function O(a, c, d) {
        function k() {
            g += h,
            j = "toNext" == i ? g > a: a > g,
            j ? (o ? e.setWrapperTranslate(Math.round(g), 0) : e.setWrapperTranslate(0, Math.round(g)), e._DOMAnimating = !0, window.setTimeout(function() {
                k()
            },
    ...
    function Q() {
        for (var a = e.paginationButtons,
        b = 0; a.length > b; b++) e.h.removeEventListener(a[b], "click", S, !1)
    }
    function R() {
        for (var a = e.paginationButtons,
        b = 0; a.length > b; b++) e.h.addEventListener(a[b], "click", S, !1)
    }
    function S(a) {
        for (var b, c = a.target || a.srcElement,
        d = e.paginationButtons,
        f = 0; d.length > f; f++) c === d[f] && (b = f);
        e.swipeTo(b)
    }
    function U() {
        e.calcSlides(),
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(a) {
        ...
        b = b || {};
        for (var m in l) if (m in b && "object" == typeof b[m]) for (var n in l[m]) n in b[m] || (b[m][n] = l[m][n]);
        else m in b || (b[m] = l[m]);
        e.params = b,
        ...
        e.init = function(a, c) {
            ...
            if (d !== e.width || f !== e.height || a) {
                ...
                if (a && e.calcSlides(c), "auto" === b.slidesPerView) {
                    ...
                    b.centeredSlides && (o ? (e.wrapperLeft = (k - this.slides[0].getWidth(!0)) / 2, e.wrapperRight = (k - e.slides[e.slides.length - 1].getWidth(!0)) / 2) : (e.wrapperTop = (k - e.slides[0].getHeight(!0)) / 2, e.wrapperBottom = (k - e.slides[e.slides.length - 1].getHeight(!0)) / 2)),
                    o ? (e.wrapperLeft >= 0 && (i.style.paddingLeft = e.wrapperLeft + "px"), e.wrapperRight >= 0 && (i.style.paddingRight = e.wrapperRight + "px")) : (e.wrapperTop >= 0 && (i.style.paddingTop = e.wrapperTop + "px"), e.wrapperBottom >= 0 && (i.style.paddingBottom = e.wrapperBottom + "px"));
                    var m = 0,
                    n = 0;
                    e.snapGrid = [],
                    e.slidesGrid = [];
                    for (var p = 0,
                    q = 0; e.slides.length > q; q++) {
                    ...
                    if (b.calculateHeight) {
                        var p = 0,
                        z = 0;
                        o || (e.container.style.height = ""),
                        i.style.height = "";
                        for (var q = 0; e.slides.length > q; q++) e.slides[q].style.height = "",
                        p = Math.max(e.slides[q].getHeight(!0), p),
                        o || (z += e.slides[q].getHeight(!0));
                        var s = p;
                        if (o) var z = s;
                        k = e.height = s,
                        o || (e.container.style.height = k + "px")
                    ...
                    e.snapGrid = [],
                    e.slidesGrid = [];
                    for (var q = 0; e.slides.length > q; q++) e.snapGrid.push(m),
                    e.slidesGrid.push(m),
                    m += g,
                    e.slides[q].style.width = r + "px",
                    e.slides[q].style.height = s + "px"
                }
                e.initialized ? e.callPlugins("onInit") : e.callPlugins("onFirstInit"),
                e.initialized = !0
            }
        },
        e.reInit = function(a) {
        ...
        var H, K, L, G = !1,
        I = !0;
        e.swipeNext = function(a) { ! a && b.loop && e.fixLoop(),
        ...
        e.swipePrev = function(a) { ! a && b.loop && e.fixLoop(),
            !a && b.autoplay && e.stopAutoplay(),
        ...
        e.swipeTo = function(a, c, d) {
            ...
            if (! (a > e.slides.length - 1 || 0 > a)) {
                var h;
                return h = "auto" == b.slidesPerView ? -e.slidesGrid[a] : -a * g,
                -v() > h && (h = -v()),
                h == f ? !1 : (d = d === !1 ? !1 : !0, O(h, "to", {
                    index: a,
                    speed: c,
                    runCallbacks: d
                }), !0)
        ...
        e.updateActiveSlide = function(a) {
            if (e.initialized && 0 != e.slides.length) {
                ...
                if (e.activeIndex == e.slides.length && (e.activeIndex = e.slides.length - 1), 0 > e.activeIndex && (e.activeIndex = 0), e.slides[e.activeIndex]) {
                    ...
                    for (var i = RegExp("\\s*" + b.slideActiveClass), j = RegExp("\\s*" + b.slideVisibleClass), d = 0; e.slides.length > d; d++) e.slides[d].className = e.slides[d].className.replace(i, "").replace(j, ""),
        ...
        e.createPagination = function(a) {
            ...
            e.paginationButtons = [],
            document.querySelectorAll ? e.paginationButtons = e.paginationContainer.querySelectorAll("." + b.paginationElementClass) : window.jQuery && (e.paginationButtons = d(e.paginationContainer).find("." + b.paginationElementClass)),
        ...
        e.updatePagination = function(a) {
            if (! (1 > e.slides.length)) {
                ...
                if (c) {
                    for (var f = e.paginationButtons,
                    g = 0; f.length > g; g++) f[g].className = b.paginationElementClass;
        ...
        e.calcVisibleSlides = function(a) {
            ...
            f = 0,
            h = 0;
            o && e.wrapperLeft > 0 && (a += e.wrapperLeft),
            !o && e.wrapperTop > 0 && (a += e.wrapperTop);
        ...
        e.createLoop = function() {
            if (0 != e.slides.length) {
                ...
                for (var a = "",
                c = "",
                d = 0; e.loopedSlides > d; d++) a += e.slides[d].outerHTML;
        ...
        e.loadSlides = function() {
            ...
            d = b.loader.loadAllSlides ? c.length: b.slidesPerView * (1 + b.loader.surroundGroups), f = 0; d > f; f++) a += "outer" == b.loader.slidesHTMLType ? c[f] : "<" + b.slideElement + ' class="' + b.slideClass + '" data-swiperindex="' + f + '">' + c[f] + "</" + b.slideElement + ">";
        ...
        e.reloadSlides = function() {
            ...
            if (! (0 > c || c > a.length - 1)) {
                ...
                if (c > 0) {
                    var h = -g * (c - d);
                    o ? e.setWrapperTranslate(h, 0, 0) : e.setWrapperTranslate(0, h, 0),
                    e.setWrapperTransition(0)
                }
                if ("reload" === b.loader.logic) {
                    e.wrapper.innerHTML = "";
                    for (var i = "",
                    j = d; f >= j; j++) i += "outer" == b.loader.slidesHTMLType ? a[j] : "<" + b.slideElement + ' class="' + b.slideClass + '" data-swiperindex="' + j + '">' + a[j] + "</" + b.slideElement + ">";
                    e.wrapper.innerHTML = i
                } else {
                    for (var k = 1e3,
                    l = 0,
                    j = 0; e.slides.length > j; j++) {
...
Swiper.prototype = {
    ...
    getWrapperTranslate: function(a) {
        ...
        return this.params.useCSS3Transforms ? ("x" == a && (d = 16 == c.length ? parseFloat(c[12]) : window.WebKitCSSMatrix ? e.m41: parseFloat(c[4])), "y" == a && (d = 16 == c.length ? parseFloat(c[13]) : window.WebKitCSSMatrix ? e.m42: parseFloat(c[5]))) : ("x" == a && (d = parseFloat(b.style.left, 10) || 0), "y" == a && (d = parseFloat(b.style.top, 10) || 0)),
        d || 0
    },
    setWrapperTranslate: function(a, b, c) {
        ...
        b = b || 0,
        c = c || 0,
        this.params.useCSS3Transforms ? this.support.transforms3d ? d.webkitTransform = d.MsTransform = d.msTransform = d.MozTransform = d.OTransform = d.transform = "translate3d(" + a + "px, " + b + "px, " + c + "px)": (d.webkitTransform = d.MsTransform = d.msTransform = d.MozTransform = d.OTransform = d.transform = "translate(" + a + "px, " + b + "px)", this.support.transforms || (d.left = a + "px", d.top = b + "px")) : (d.left = a + "px", d.top = b + "px"),
    ...
    h: {
        ...
        getHeight: function(a, b) {
            ...
            d = parseFloat(c);
            return (isNaN(d) || c.indexOf("%") > 0) && (d = a.offsetHeight - parseFloat(window.getComputedStyle(a, null).getPropertyValue("padding-top")) - parseFloat(window.getComputedStyle(a, null).getPropertyValue("padding-bottom"))),
